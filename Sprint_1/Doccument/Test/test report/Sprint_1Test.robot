...
Review Success:
    ...
    Execute JavaScript    document.evaluate("(//span[contains(@class,'cursor-pointer')])[4]",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
...
Review Success without image:
    ...
    Wait Until Element Is Visible    xpath=//button[contains(.,'รีวิวการเดินทาง')]
    Click Element    xpath=//button[contains(.,'รีวิวการเดินทาง')]
    Execute JavaScript    document.evaluate("(//span[contains(@class,'cursor-pointer')])[5]",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
    Input Text    xpath=//textarea    บริการดีมากครับ
    #Scroll Element Into View    xpath=//button[contains(.,'ส่งรีวืว')]
    #Wait Until Element Is Visible    xpath=//button[contains(.,'ส่งรีวิว')]    10s
    Execute JavaScript    document.evaluate("//button[normalize-space()='ส่งรีวิว']",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
    Capture Page Screenshot
...
Review Success without comment and image:
    Open Browser    ${TEST_URL}    ${BROWSER}
    Maximize Browser Window
    Wait Until Element Is Visible    css=a[href="/login"]    15s
    Click Element    css=a[href="/login"]
    ...
    Wait Until Element Is Visible    xpath=//button[contains(.,'รีวิวการเดินทาง')]
    Click Element    xpath=//button[contains(.,'รีวิวการเดินทาง')]
    Execute JavaScript    document.evaluate("(//span[contains(@class,'cursor-pointer')])[2]",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
    #sleep    10 seconds
    #Scroll Element Into View    xpath=//button[contains(.,'ส่งรีวืว')]
    #Wait Until Element Is Visible    xpath=//button[contains(.,'ส่งรีวิว')]    10s
    Execute JavaScript    document.evaluate("//button[normalize-space()='ส่งรีวิว']",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
...
Review Unsuccess Without Score:
    Open Browser    ${TEST_URL}    ${BROWSER}
    Maximize Browser Window
    Wait Until Element Is Visible    css=a[href="/login"]    15s
    Click Element    css=a[href="/login"]
    ...
    #Wait Until Element Is Visible    xpath=//button[contains(.,'ส่งรีวิว')]    10s
    Execute JavaScript    document.evaluate("//button[normalize-space()='ส่งรีวิว']",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click(); 
    Page Should Contain    กรุณาให้คะแนนก่อนส่งรีวิว    
    Capture Page Screenshot
    Close Browser

Review Unsuccess Oversize Image:
    Open Browser    ${TEST_URL}    ${BROWSER}
    Maximize Browser Window
    Wait Until Element Is Visible    css=a[href="/login"]    15s
    Click Element    css=a[href="/login"]
    ...
    Execute JavaScript    document.evaluate("(//span[contains(@class,'cursor-pointer')])[4]",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
    Input Text    xpath=//textarea    ดีมากครับ
    Choose File    xpath=//input[@type='file']    C:/Users/Dom/Downloads/professerEX (1).jpg
    #sleep    10 seconds
    #Scroll Element Into View    xpath=//button[contains(.,'ส่งรีวืว')]
    #Wait Until Element Is Visible    xpath=//button[contains(.,'ส่งรีวิว')]    10s
    Execute JavaScript    document.evaluate("//button[normalize-space()='ส่งรีวิว']",    document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null)    .singleNodeValue.click();
