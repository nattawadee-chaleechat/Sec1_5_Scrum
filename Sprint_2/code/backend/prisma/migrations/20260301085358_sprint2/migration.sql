/*
  ...
  - Added the required column `baseTotalPrice` to the `Booking` table without a default value. This is not possible if the table is not empty.
  - Added the required column `extraTotalPrice` to the `Booking` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Booking" ADD COLUMN     "baseTotalPrice" DOUBLE PRECISION NOT NULL,
ADD COLUMN     "completedAt" TIMESTAMP(3),
ADD COLUMN     "driver_confirm_arrived" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "extraTotalPrice" DOUBLE PRECISION NOT NULL,
