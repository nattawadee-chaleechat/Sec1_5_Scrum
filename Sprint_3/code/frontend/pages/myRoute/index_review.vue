...
<template>
  <div>
    <div class="px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
      <div class="mb-8">
        <h2 class="text-2xl font-bold text-gray-900">รีวิวเส้นทางของฉัน</h2>
        <p class="mt-2 text-gray-600">
          ดูรีวิวและความคิดเห็นจากผู้โดยสารเกี่ยวกับเส้นทางของคุณ
        </p>
      </div>

      <div class="bg-white border border-gray-300 rounded-lg shadow-md">
        <div class="p-6 border-b border-gray-300">
          <h3 class="text-lg font-semibold text-gray-900">รีวิวจากผู้โดยสาร</h3>
        </div>
                ...
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                      ผู้โดยสาร: {{ review.passengerName || 'ผู้ใช้ไม่ระบุชื่อ' }}
                    </p>
                  </div>
        ...
        <div class="modal-content">
          ...
          <div v-if="selectedReview" class="p-6">
            ...
            <div class="mb-6 pb-6 border-b border-gray-300">
              <h4 class="mb-3 font-semibold text-gray-900">หมายเหตุเส้นทาง</h4>
            ...
            <!-- Passenger Info -->
            <div class="mb-6 pb-6 border-b border-gray-300">
              <h4 class="mb-3 font-semibold text-gray-900">ข้อมูลผู้โดยสาร</h4>
              <div class="p-3 rounded-lg bg-gray-50">
                <div class="font-medium text-gray-900">
                  {{ selectedReview.passengerName || 'ผู้ใช้ไม่ระบุชื่อ' }}
                </div>
...
onMounted(async () => {
  try {
    ...
    const response = await $api('/review/my-reviews')
    if (response?.reviews) {
