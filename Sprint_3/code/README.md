...
- **ChatGPT (GPT-4o, GPT-4.1, GPT-5.3)** 
- **Claude (Claude Haiku 4.5)** 
- **Gemini AI (Gemini 1.5 Flash, Gemini 3 Thinking)** 
- **GitHub Copilot**

โครงงานนี้ได้มีการนําปัญญาประดิษฐ์ในข้างต้นมาใช้ในขั้นตอนต่อไปนี้

 - ใช้ในการวางแผนและออกแบบระบบเพื่อตรวจสอบความครบถ้วนของข้อมูล และให้สอดคล้องกับ Item backlog ที่ได้รับมาในแต่ละ sprint 
 -  ใช้เป็นแนวทางในการกำหนดโครงสร้างและแนวทางการเขียนโค้ดในการ Test ในส่วนต่าง ๆ รวมถึงส่วน backend เพื่อให้โค้ดมีความเป็นระเบียบและง่ายต่อการบำรุงรักษาโค้ด
 - ใช้ตรวจสอบความถูกต้องและเพิ่มประสิทธิภาพให้กับโค้ด เพื่อลดข้อผิดพลาดทางเทคนิค
 - ใช้ในการออกแบบหน้าจอการใช้งานเบื้องต้นในส่วนของ frontend   เพื่อลดขั้นตอนที่ไม่จำเป็น และช่วยให้การพัฒนาระบบสามารถดำเนินการได้รวดเร็วขึ้น
 - ใช้ในการปรับแต่งภาษาภายในเอกสารให้มีความเป็นภาษาเขียนและเป็นทางการมากขึ้น 

โดยข้าพเจ้าได้ ตรวจสอบความถูกต้องและแก้ไขข้อผิดพลาดอันเนื่องมาจากผลลัพธ์จากปัญญาประดิษฐ์เรียบร้อยแล้ว
